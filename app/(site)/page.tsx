...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-surface text-text mt-14">
      {/* Hero Section */}
      <section className="bg-linear-to-br from-brand-soft to-transparent">
        <div className="max-w-6xl mx-auto px-6 py-16 md:py-24">
          <div className="grid lg:grid-cols-2 gap-2 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <h2 className="text-xl sm:text-2xl md:text-3xl font-light text-brand mb-6">
                Orientation et accompagnement pour la circoncision médicale en France
              </h2>

              <p className="text-muted leading-relaxed mb-10 max-w-xl mx-auto lg:mx-0">
                {/* Mobile */}
                <span className="lg:hidden">
                  Un accompagnement clair, confidentiel et structuré, pour vous orienter vers un médecin partenaire
                  qualifié.
                </span>
            ...
            <div>
              ...
              <div className="mt-8 lg:hidden flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  href="/contact"
                  className="inline-flex items-center justify-center px-8 py-4 bg-brand text-brand-foreground rounded-full font-medium hover:opacity-90 transition-all duration-300 group"
                >
